...
const states = ['Delhi', 'Maharashtra', 'Karnataka', 'Tamil Nadu', 'Uttar Pradesh', 'West Bengal', 'Gujarat', 'Rajasthan', 'Telangana'];
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case 'email':
        ...
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(value)) return 'Enter a valid email.';
        return '';
      case 'mobileNumber':
      ...
      case 'gstNumber':
        ...
        if (!/^[0-9A-Z]{15}$/.test(value)) return 'Enter a valid 15-char GSTIN.';
        return '';
      default:
        return '';
    }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.notice}>
        ...
        <button className={styles.loginLink} onClick={handleLogin}>Login</button>
      </div>
      ...
      <div className={styles.layout}>
        ...
        <main className={styles.left}>
          <section className={styles.card}>
            ...
            {/* Form Wrapper for Local Input Styles */}
            <form onSubmit={HandleSubmit} noValidate className={styles.travellerInput}>
              ...
              <fieldset className={styles.grid3}>
                <div className={styles.field}>
                  ...
                  {touched.firstName && errors.firstName && (
                    <p id="firstName-error" className={styles.error}>{errors.firstName}</p>
                  )}
                </div>
                ...
                <div className={styles.field}>
                  ...
                  {touched.lastName && errors.lastName && (
                    <p id="lastName-error" className={styles.error}>{errors.lastName}</p>
                  )}
                </div>

                <div className={styles.field}>
                  <span className={styles.label}>Gender</span>
                  <div className={styles.radioGroup} role="radiogroup" aria-label="Gender">
                ...
                <div className={styles.field}>
                  ...
                  <select
                    ...
                    onChange={(e) => dispatch({ type: 'countryCode', val: e.target.value })}
                  >
                ...
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    onChange={(e) => dispatch({ type: 'mobileNumber', val: e.target.value.replace(/\D/g, '') })}
                    onBlur={handleBlur}
                  ...
                  {touched.mobileNumber && errors.mobileNumber && (
                    <p id="mobileNumber-error" className={styles.error}>{errors.mobileNumber}</p>
                  )}
                </div>
                ...
                <div className={styles.rowFull}>
                  <label className={styles.checkbox}>
                    <input
                      ...
                      onChange={(e) => dispatch({ type: 'wheelchair', val: e.target.checked })}
                    />
              ...
              {/* Booking Contact */}
              <fieldset className={styles.grid3}>
                <legend className={styles.legend}>Booking details will be sent to</legend>
                <div className={styles.field}>
                ...
                <div className={styles.rowFull}>
                  <label className={styles.checkbox}>
                    <input
                      ...
                      onChange={(e) => dispatch({ type: 'hasGst', val: e.target.checked })}
                    />
                ...
                {state.hasGst && (
                  <div className={styles.field}>
                    ...
                    <input
                      ...
                      onChange={(e) => dispatch({ type: 'gstNumber', val: e.target.value.toUpperCase() })}
                      onBlur={handleBlur}
                      aria-invalid={!!errors.gstNumber && touched.gstNumber}
                      aria-describedby="gstNumber-error"
                    />
                    {touched.gstNumber && errors.gstNumber && (
                      <p id="gstNumber-error" className={styles.error}>{errors.gstNumber}</p>
                    )}
                  </div>
                )}
              </fieldset>
              ...
              <fieldset className={styles.grid3}>
                <div className={styles.field}>
                  ...
                  <select
                    id="state"
                    value={state.state}
                    onChange={(e) => dispatch({ type: 'state', val: e.target.value })}
                  >
                ...
                <div className={styles.rowFull}>
                  <label className={styles.checkbox}>
                    <input
                      ...
                      onChange={(e) => dispatch({ type: 'saveToTravellerList', val: e.target.checked })}
                    />
